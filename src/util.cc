...
//  constexpr std::complex<double> I;
  ...
  namespace { // anonymous namespace for "private" members 
    size_t get_mem_info(const std::string& key) {
  ...
  size_t get_mem_total() { return get_mem_info("MemTotal") * 1000; }
  
  size_t get_mem_avail() { return get_mem_info("MemAvailable") * 1000; }
}
