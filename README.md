...
The efficiency and correctness of any edge cases, any configurations significantly from the default values or published configurations are not garenteed.
